...
const LoginPage: Page = () => {
  ...
  return (
    <div>
      ...
      <div className="flex w-[810] items-center justify-center  flex-col min-h-[450px] h-[850px]" style={{background: "#fdfcf0"}}>
        <div className="shadow-md px-12 py-12 landscape-form flex flex-col h-[310] w-[980px] relative" style={{background: "#f0f0e1"}}>
          <div className = "h-16 w-28 absolute left-0 top-0 -translate-y-full flex justify-center items-center rounded-t-lg" style={{background: "#f0f0e1"}}>
            <Link href="" className = "text-red-700  ">Login</Link>  
          </div>
          <div className = "h-16 w-28 absolute left-32 top-0 -translate-y-full flex justify-center items-center rounded-t-lg bg-red-700 ">
            <Link href="../user/register" className = "text-white">SignUp</Link>  
          </div>
