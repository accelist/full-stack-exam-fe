        ...
        <div className='flex flex-col items-center justify-center h-screen w-full gap-6 relative'>
            <nav className="w-full px-8 py-4 bg-gray-100 border-b border-gray-300 absolute top-0 left-0">
                <ol className="flex space-x-4">
                    ...
                    <li>/</li>
                    <li>
                        <Link href="/admin/genres" className="text-blue-600 hover:text-blue-800">
                            Genre
                        </Link>
                    </li>
                </ol>
            ...
            <div className='flex justify-center items-center gap-4 mt-4'>
                ...
                <Button
                    onClick={() => router.push('/admin/genres/update')}
                ...
                <Button
                    onClick={() => router.push('/admin/genres/delete')}
...
GenrePage.layout = WithAdminLayout;
